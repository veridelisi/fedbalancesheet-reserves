...
# --- Styling (enhanced CSS + badge helper) ---
st.markdown("""
<style>
...
- 💰 Smart formatting: **$1.2B** (billions), **$500M** (millions)
- 🏷️ Significance badges: **🔥 Major** (5B+), **⚡ High** (1B+), **📈 Medium** (500M+), **💭 Low** (<500M)
- 🎛️ Interactive controls: **Sort** by impact/name, **Filter** by threshold, **View** compact/detailed
- 📊 Summary statistics: total impacts and key insights
- 🎨 Color-coded impacts: **Green** (positive for reserves), **Red** (negative for reserves)
        """
    )
